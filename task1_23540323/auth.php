...
function require_login() {
    if (!is_logged_in()) { set_flash("error", "Please log in to continue."); redirect("login"); }
}
function require_admin() {
    require_login();
    if (current_role() !== "admin") { set_flash("error", "Admins only."); redirect("home"); }
}
function require_customer() {
    require_login();
    if (current_role() !== "customer") { set_flash("error", "Customer account required."); redirect("home"); }
}
